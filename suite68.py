...
def update():
    ...
    if vaisseau_y <= balle_y +6 <= vaisseau_y   and vaisseau_x + 24 <= balle_x <=vaisseau_x + 25 +24 :
        deplacement_vertical = -3 
...
def draw():
    ...
    #brique_x1
     ...
     #brique_y2
        ...
        elif 25 + 17 <= balle_y <= 25+17+3 and 10 < balle_x < 10+26 and vies_brique_2 > 0 :
            vies_brique_2 = vies_brique_2 - 1
            deplacement_vertical = -1 #1
    ...
    #brique_x2
        ...
        elif 25 <= balle_y <= 50 and 10 <= balle_x <= 10+1 and vies_brique_2 > 0 :
            vies_brique_2 = vies_brique_2 - 1
            deplacement_vertical = 1 #-1
    ...
    #brique_y3
        ...
        if 25 <= balle_y <= 27 and 10+25+10 <= balle_x <= 10+25+10+26 and vies_brique_3 > 0 :
            vies_brique_3 = vies_brique_3 - 1
            deplacement_vertical = 1 #-1

        elif 25 + 17 <= balle_y <= 25+17+3 and 10+25+10 < balle_x < 10+25+10+26 and vies_brique_3 > 0 :
            vies_brique_3 = vies_brique_3 - 1
            deplacement_vertical = -1 #1
    ...
    #brique_y7
        ...
        if 25 <= balle_y <= 27 and 10+25+10+25+10+25+10+25+10+25+10+25+10 <= balle_x <= 10+25+10+25+10+26+25+10+25+10+25+10+25+10 and vies_brique_7 > 0 :
            vies_brique_7 = vies_brique_7 - 1
            deplacement_vertical = 1 #-1

        elif 25 + 17 <= balle_y <= 25+17+3 and 10+25+10+25+10+25+10+25+10+25+10+25+10 < balle_x < 10+25+10+25+10+26+25+10+25+10+25+10+25+10  and vies_brique_7 > 0 :
            vies_brique_7 = vies_brique_7 - 1
            deplacement_vertical = -1 #1
    ...
    #brique_x7
        ...
        if 25 <= balle_y <= 50 and 10+25+10+25+10+25+10+25+10+25+10+25+10 <= balle_x <= 10+25+10+1+25+10+25+10+25+10+25+10+25+10  and vies_brique_7 > 0 :
            vies_brique_7 = vies_brique_7 - 1
            deplacement_vertical = 1 #-1

        elif 25 <= balle_y <= 50 and 10+25+10+25+10+25+10+25+10+25+10+25+10  <= balle_x <= 10+25+10+1+25+10+25+10+25+10+25+10+25+10  and vies_brique_7 > 0 :
            vies_brique_7 = vies_brique_7 - 1
            deplacement_vertical = 1 #-1
...
#fin
    ...
    if vies_brique_1 == 0 and vies_brique_2 == 0 and vies_brique_3 == 0 and vies_brique_4 == 0 and vies_brique_5 == 0 and vies_brique_6 == 0 and vies_brique_7 == 0:
        pyxel.cls(0)
